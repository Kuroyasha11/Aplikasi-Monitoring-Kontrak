    ...
    <div class="col-lg-15">
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <a href="/dashboard/warehouse/create" class="btn btn-success"><i class="bi bi-plus-square"></i> Tambah</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex  justify-content-center">
                                        <a href="/dashboard/warehouse/{{ $item->id }}/edit" class="btn btn-warning"><i

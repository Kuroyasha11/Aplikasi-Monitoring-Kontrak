    ...
    <div class="col-lg-15">
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <a href="/dashboard/management-warehouse/create" class="btn btn-success"><i class="bi bi-plus-square"></i>
                    Tambah</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex  justify-content-center">
                                        <a href="/dashboard/management-warehouse/{{ $item->id }}/edit"
                                            class="btn btn-warning"><i class="bi bi-pencil-square"></i> Edit</a>
                                        <form action="/dashboard/management-warehouse/{{ $item->id }}" method="post">
                                            @method('delete')
                                            @csrf

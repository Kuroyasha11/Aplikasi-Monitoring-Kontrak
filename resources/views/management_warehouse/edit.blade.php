...
@section('container')
    <div class="col-lg-15">
        ...
        <form action="/dashboard/management-warehouse/{{ $request->id }}" method="post">
            @method('put')
            @csrf
            <div class="form-group">
                <label for="nama">Nama</label>
                <input type="text" id="nama" name="nama" class="form-control @error('nama') is-invalid @enderror"
                    value="{{ old('nama', $request->nama) }}" autofocus required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="number" id="hargadasar" name="hargadasar"
                    ...
                    value="{{ old('hargadasar', $request->hargadasar) }}" required>
                @error('hargadasar')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="d-flex">
                ...
                <a href="/dashboard/management-warehouse" class="btn btn-warning"><i class="bi bi-arrow-left"></i>
                    Kembali</a>
            </div>
        </form>
    </div>

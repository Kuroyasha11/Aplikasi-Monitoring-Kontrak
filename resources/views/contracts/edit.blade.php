        ...
        <form action="/dashboard/contract/{{ $contract->id }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="id_storage" name="id_storage"
                    class="form-control @error('id_storage') is-invalid @enderror"
                    value="{{ old('id_storage', $contract->storage_id) }}" autofocus required>
                @error('id_storage')
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" class="form-control @error('nama') is-invalid @enderror"
                    value="{{ old('nama', $contract->nama) }}" required>
                @error('nama')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control  @error('keterangan') is-invalid @enderror"
                    value="{{ old('keterangan', $contract->keterangan) }}" placeholder="Keterangan" id="keterangan" name="keterangan"
